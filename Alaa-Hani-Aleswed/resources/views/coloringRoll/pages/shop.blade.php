               ...
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-30 wow itfadeUp" data-wow-duration=".9s"
                  ...
                  <div class="it-shop-item text-center">
                     <div class="it-shop-thumb p-relative">
                        <img class="w-100" src="{{ asset('coloringRoll/img/shop/thumb-1-1.jpg')}}" alt="">
                        <div class="it-shop-badge-item">
                           <span>sale</span>
                        </div>
                     </div>
                     <div class="it-shop-content-box">
                        <div class="it-shop-content">
                           <h4 class="it-shop-title pb-15"><a href="shop-details.html">School Bag</a></h4>
                           <div class="it-shop-rate mb-20">
                              <span class="color"><del>$150.00</del>$100.00</span>
                              <span><i class="fal fa-star"></i> 4.5k</span>
                           </div>
                           <div class="it-shop-button">
                              <a class="it-btn-sm" href="cart.html">
                                 <span>Shop now
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-30">
            <div class="it-shop-item text-center">
                <div class="it-shop-thumb p-relative">
                    ...
                    @else
                        <img class="w-100"
                             src="{{ asset('coloringRoll/img/shop/thumb-placeholder.jpg') }}"
                             alt="No image">
                    @endif
                </div>
