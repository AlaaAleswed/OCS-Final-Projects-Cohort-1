                     ...
                     <div id="checkout-login" class="coupon-content">
                        <div class="coupon-info">
                           ...
                           <form action="checkout.html#">
                              ...
                              <p class="form-row">
                                 <button class="it-btn circle-effect" type="submit">Login</button>
                                 <label>
                                    <input type="checkbox">
                                    Remember me
                                 </label>
                        ...
                        <div class="coupon-info">
                           <form action="checkout.html#">
                              <p class="checkout-coupon">
                                 ...
                                 <button class="it-btn circle-effect" type="submit">Apply Coupon</button>
                              </p>
                           </form>
                        </div>
                     </div>
                     ...
                     <div class="your-order mb-30 ">
                        ...
                        <div class="payment-method">
                           ...
                           <div class="order-button-payment mt-20">
                              <button type="submit" class="it-btn circle-effect">Place order</button>
                           </div>
                        </div>
                     </div>
                  </div>
